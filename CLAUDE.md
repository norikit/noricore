# CLAUDE.md — entry point for agents working in noricore
...
## This project: noricore

**noricore** — the event broker and data backbone that serves system state to every tool.
